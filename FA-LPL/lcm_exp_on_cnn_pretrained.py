...
log_txt_name = '20NG_CNN_log'  # maxlen = 300, lcm_stop: lcm:30, two_loss: 30
num_classes = 20
...
# log_txt_name = 'AG_CNN_log' # lcm_stop: 6, two_loss: 5  四个均未使用dropout   epochs: 30/50
# num_classes = 4
...
# log_txt_name = 'DBPedia_CNN' # AG_CNN_log   # 使用dropout=0.4,且学习率为1e-4, lcm_stp:  30, 30
# num_classes = 14
...
# log_txt_name = 'Fudan_CNN_log'   # maxlen = 300    # epochs=50, two_loss: 30
# num_classes = 20
...
log_txt_name = log_txt_name + '_pre'
...
for n in range(N):
    ...
    print('--Round ', n+1)
    print('====Original:============')
    # basic_model = cnn.CNN_Basic(maxlen,vocab_size,wvdim,hidden_size,num_classes,embedding_matrix, filter_sizes=filter_sizes, num_filters=num_filters)
    ...
    #
    # print('====LS:============')
    # ls_model = cnn.CNN_LS(maxlen,vocab_size,wvdim,hidden_size,num_classes,embedding_matrix, filter_sizes=filter_sizes, num_filters=num_filters)
    ...
    #
    # print('====LCM:============')
    # dy_lcm_model = cnn.CNN_LCM(maxlen,vocab_size,wvdim,hidden_size,num_classes,alpha,None,embedding_matrix, filter_sizes=filter_sizes, num_filters=num_filters)
    ...
    print("====loss1:==========")
    loss_lcm = cnn.CNN_two_loss(maxlen, vocab_size, wvdim, hidden_size, num_classes, 3, None, embedding_matrix, filter_sizes=filter_sizes, num_filters=num_filters)
